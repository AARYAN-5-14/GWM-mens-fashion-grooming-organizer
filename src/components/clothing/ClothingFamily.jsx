...
import bgVideo from '../../assets/family_gathering.mp4';
  ...
  return (
    <div className='main'>
      ...
      <div className='clothing-category-section'>
        {/* Card 1 — Accessories */}
        <div className='clothing-card' onClick={() => navigate('/clothing/family/accessories')}>
        ...
        {/* Card 2 — Fragrance */}
        <div className='clothing-card' onClick={() => navigate('/clothing/family/fragrance')}>
          <div className='clothing-card-wrapper'>
        ...
        {/* Card 3 — Dresses */}
        <div className='clothing-card' onClick={() => navigate('/clothing/family/dresses')}>
          <div className='clothing-card-wrapper'>
        ...
        {/* Card 4 — Watches */}
        <div className='clothing-card' onClick={() => navigate('/clothing/family/watches')}>
          <div className='clothing-card-wrapper'>
        ...
        {/* Card 5 — Footwears */}
        <div className='clothing-card' onClick={() => navigate('/clothing/family/footwears')}>
          <div className='clothing-card-wrapper'>
