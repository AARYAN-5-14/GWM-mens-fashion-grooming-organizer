...
import bgVideo from '../../assets/party.mp4';
  ...
  return (
    <div className='main'>
      ...
      <div className='clothing-category-section'>
        {/* Card 1 — Accessories */}
        <div className='clothing-card' onClick={() => navigate('/clothing/party/accessories')}>
        ...
        {/* Card 2 — Fragrance */}
        <div className='clothing-card' onClick={() => navigate('/clothing/party/fragrance')}>
          <div className='clothing-card-wrapper'>
        ...
        {/* Card 3 — Dresses */}
        <div className='clothing-card' onClick={() => navigate('/clothing/party/dresses')}>
          <div className='clothing-card-wrapper'>
        ...
        {/* Card 4 — Watches */}
        <div className='clothing-card' onClick={() => navigate('/clothing/party/watches')}>
          <div className='clothing-card-wrapper'>
        ...
        {/* Card 5 — Footwears */}
        <div className='clothing-card' onClick={() => navigate('/clothing/party/footwears')}>
          <div className='clothing-card-wrapper'>
