...
import bgVideo from '../../assets/date.mp4';
  ...
  return (
    <div className='main'>
      ...
      <div className='clothing-category-section'>
        {/* Card 1 — Accessories */}
        <div className='clothing-card' onClick={() => navigate('/clothing/date/accessories')}>
        ...
        {/* Card 2 — Fragrance */}
        <div className='clothing-card' onClick={() => navigate('/clothing/date/fragrance')}>
          <div className='clothing-card-wrapper'>
        ...
        {/* Card 3 — Dresses */}
        <div className='clothing-card' onClick={() => navigate('/clothing/date/dresses')}>
          <div className='clothing-card-wrapper'>
        ...
        {/* Card 4 — Watches */}
        <div className='clothing-card' onClick={() => navigate('/clothing/date/watches')}>
          <div className='clothing-card-wrapper'>
        ...
        {/* Card 5 — Footwears */}
        <div className='clothing-card' onClick={() => navigate('/clothing/date/footwears')}>
          <div className='clothing-card-wrapper'>
